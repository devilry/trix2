...
# from django_cradmin.viewhelpers.formview import objecttable
# from django_cradmin.viewhelpers.formview import create
# from django_cradmin.viewhelpers.formview import update
# from django_cradmin.viewhelpers.formview import delete
# from django_cradmin.viewhelpers.formview import multiselect
...
class AssignmentCreateView(AssignmentCreateUpdateMixin, viewhelpers.formview.WithinRoleCreateView):
    """
    View used to create new assignments.
    """


class AssignmentUpdateView(AssignmentQuerysetForRoleMixin, AssignmentCreateUpdateMixin, viewhelpers.formview.WithinRoleUpdateView):
    """
...
class AssignmentDeleteView(AssignmentQuerysetForRoleMixin, viewhelpers.formview.WithinRoleDeleteView):
    """
